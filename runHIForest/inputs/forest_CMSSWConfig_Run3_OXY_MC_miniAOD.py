...
mylist = FileUtils.loadListFromFile('my_pO_test_miniaod.txt')
###############################################################################
...
process.GlobalTag = GlobalTag(process.GlobalTag, '150X_mcRun3_2025_forpO_realistic_v8', '')
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('my_pO_test_miniaod.root'))
...
process.HiGenParticleAna.ptMin = cms.untracked.double(0.1)   # changed for pO low-pT gen particles
